...
<style>
    /* Menyembunyikan ikon mata bawaan di Chrome/Safari */
    .hide-browser-toggle::-webkit-contacts-toggle-button,
    ...
    /* Menyembunyikan ikon bawaan di Edge/IE */
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-4">
            ...
            <div class="relative">
                ...
                <input type="password" name="password" id="password" placeholder="Masukkan password anda"
                        class="w-full border border-gray-300 rounded-lg px-3 py-2 pr-12 focus:ring focus:ring-blue-300 hide-browser-toggle">
